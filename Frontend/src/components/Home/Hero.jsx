      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between w-full gap-12 lg:gap-20">
          <div className="md:w-1/2 flex flex-col items-center md:items-start">
            ...
            <blockquote className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl  font-bold mb-8 md:leading-tight text-justify md:text-left text-gray-800">
              "If you continue doing business today with the methods of yesterday, you are bound to go out of business tomorrow."
            </blockquote>
            <Link to='/about' className="group bg-[#B8860B] px-8 py-3 rounded-sm text-white text-base font-semibold hover:bg-[#996D1D] transition-colors duration-300 flex items-center gap-2">
              Know more
