        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none mb-12">
              <p>
                Dr. Pawan Verma is a professional speaker, who has spoken at a number of academic conferences, corporate
                events and industry platforms, both in India and abroad. His rich professional background and experience
                makes him the ideal person to share his thoughts and experiences on topics such as leadership and
                management, innovation and creativity, motivation and team-building, etc. He is also a domain-expert in
                insurance.
              </p>

              <p>
                Pawan was the Chairman of the ETFs Asia Conference at Hong Kong in 2012 and 2013. He has also addressed
                the APAC Financial Services Technology Summits at multiple occasions in Hong Kong, Macau and Kuala
                Lumpur.
              </p>

              <p>
                He was the Key Note Speaker at the Centenary Celebrations of the Osmania University, Hyderabad. He has
                also addressed academic conferences organized by institutions such as, SOA University, Bhubaneshwar,
                National Insurance Academy, Bombay Management Association, etc.
              </p>

              <p>
                Pawan has also spoken at a large number of corporate events and conferences, such as, ICICI Bank's CEO
                Knowledge Forum, top management seminars of Indian Postal Life Insurance, etc. He has also addressed
                industry forums like, CII, FICCI, Indian Merchants Chamber, etc. and moderated Expert Panel discussions
                on issues related to Information Technology, Financial Services, etc.
              </p>

              <p>
                As a leadership speaker, Pawan provokes an intellectual curiosity and offers a disruptive perspective on
                the subject in line with the realities of the VUCA world. Being an interactive speaker, he keeps his
                audiences connected and engaged through his humor and high energy. His wider & non-judgmental approach
                appeals to audiences across cultures and industry domains.
              </p>
            </div>
          </div>
        </div>
